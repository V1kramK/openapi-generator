...
// Import Get_Pet_Pet_IdMCPTool - included in same package
// Import Put_PetMCPTool - included in same package
// Import Get_Pet_Find_By_StatusMCPTool - included in same package
// Import Get_Pet_Find_By_TagsMCPTool - included in same package
// Import Delete_Pet_Pet_IdMCPTool - included in same package
// Import Post_PetMCPTool - included in same package
// Import Get_User_LoginMCPTool - included in same package
// Import Post_UserMCPTool - included in same package
// Import Post_User_Create_With_ArrayMCPTool - included in same package
// Import Delete_User_UsernameMCPTool - included in same package
// Import Put_User_UsernameMCPTool - included in same package
// Import Get_User_LogoutMCPTool - included in same package
// Import Post_User_Create_With_ListMCPTool - included in same package
// Import Get_User_UsernameMCPTool - included in same package
// Import Post_Store_OrderMCPTool - included in same package
// Import Delete_Store_Order_Order_IdMCPTool - included in same package
// Import Get_Store_InventoryMCPTool - included in same package
// Import Get_Store_Order_Order_IdMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Get_Pet_Pet_IdMCPTool.createGet_Pet_Pet_IdTool(config),
            Put_PetMCPTool.createPut_PetTool(config),
            Get_Pet_Find_By_StatusMCPTool.createGet_Pet_Find_By_StatusTool(config),
            Get_Pet_Find_By_TagsMCPTool.createGet_Pet_Find_By_TagsTool(config),
            Delete_Pet_Pet_IdMCPTool.createDelete_Pet_Pet_IdTool(config),
            Post_PetMCPTool.createPost_PetTool(config),
            Get_User_LoginMCPTool.createGet_User_LoginTool(config),
            Post_UserMCPTool.createPost_UserTool(config),
            Post_User_Create_With_ArrayMCPTool.createPost_User_Create_With_ArrayTool(config),
            Delete_User_UsernameMCPTool.createDelete_User_UsernameTool(config),
            Put_User_UsernameMCPTool.createPut_User_UsernameTool(config),
            Get_User_LogoutMCPTool.createGet_User_LogoutTool(config),
            Post_User_Create_With_ListMCPTool.createPost_User_Create_With_ListTool(config),
            Get_User_UsernameMCPTool.createGet_User_UsernameTool(config),
            Post_Store_OrderMCPTool.createPost_Store_OrderTool(config),
            Delete_Store_Order_Order_IdMCPTool.createDelete_Store_Order_Order_IdTool(config),
            Get_Store_InventoryMCPTool.createGet_Store_InventoryTool(config),
            Get_Store_Order_Order_IdMCPTool.createGet_Store_Order_Order_IdTool(config)
            );
